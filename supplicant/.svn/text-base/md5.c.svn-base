 ...
 *
 * I forget the source of this code, kind of some RFC written by Rivest.
 */
 ...
 * @param inputLen: length of input block (in bytes)
 */
...
/*
 * MD5str --
 *   Compute md5 sum of a string.
 */
void MD5str(char *str, unsigned char digest[16])
{
    assert(str != NULL && digest != NULL);
