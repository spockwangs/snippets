 ...
 *
 * Time-stamp: <2010-07-11 16:08:16 wbb>
 */
...
public class Codegen {
    ...
    static Temp.Temp eax = new Temp.Temp("eax");
    static Temp.Temp ebx = new Temp.Temp("ebx");
    static Temp.Temp ecx = new Temp.Temp("ecx");
    static Temp.Temp edx = new Temp.Temp("edx");
    static Temp.Temp ebp = new Temp.Temp("ebp");
    static Temp.Temp esp = new Temp.Temp("esp");
    static Temp.Temp edi = new Temp.Temp("edi");
    static Temp.Temp esi = new Temp.Temp("esi");
    ...
    static Temp.TempList returnSink = L(esp, calleesaves);
        ...
        if (m.exp instanceof Tree.BINOP) {
            ...
            if (bin_exp.binop == Tree.BINOP.PLUS) {
                ...
                if (bin_exp.right instanceof Tree.CONST) {
                    ...
                    emit(new Assem.OPER("    movl %s0, " + i + "(%d0)\n",
                                        L(r1, null), L(r_src, null)));
                    return;
    ...
    void munchCjump(Tree.CJUMP s) {
        ...
        l = munchExp(s.left);
        r = munchExp(s.right);
        label = munchName(new Tree.NAME(s.iftrue));
        ...
        emit(new Assem.OPER(instr + s.iftrue + "\n",
                            null, null, new Temp.LabelList(s.iftrue, null)));
    }
