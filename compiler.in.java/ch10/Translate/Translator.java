...
public class Translator {
    ...
    /**
     * Accumulate procedure fragments.
     */
    ...
    public Exp simpleVar(Access a, Level l) {
        ...
        Tree.Exp fp = new Tree.TEMP(frame.FP()); // frame pointer of this level
        while (l != a.home) {
    ...
    public Exp callExp(Label name, Level dec_level, Level call_level, ExpList explist) {
        ...
        Level l = call_level;
        Tree.Exp sl = new Tree.TEMP(frame.FP());
        while (l != dec_level) {
    ...
    public Exp recordExp(ExpList el) {
        ...
        Tree.ExpList args = new Tree.ExpList(new Tree.CONST(n*frame.wordSize()), null);
        Tree.Exp alloc_exp = frame.externalCall("malloc", args);
    ...
    public Exp eseqExp(ExpList el) {
        ...
        if (el.tail == null)
            ...
            return new Ex(new Tree.ESEQ(el.head.unNx(), eseqExp(el.tail).unEx()));
    }
    ...
    public Exp arrayExp(Exp size, Exp init) {
        ...
        return new Ex(frame.externalCall("initArray", args));
    }
