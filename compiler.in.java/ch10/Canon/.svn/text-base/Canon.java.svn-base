...
/**
 * Convert a call-exp to a move-exp to resolve the conflicts of
...
public class Canon {
    ...
    /**
     * Construct a SEQ exp of a and b.
     */
    ...
    /**
     * Eliminate all ESEQ nodes under 'e'.
     */
    ...
    /**
     * Given subexpression list from a statement or expression, eliminate
     * all ESEQ nodes and resolve the conflicts invoked by CALL.
     */
    ...
    /**
     * Convert a structured tree statement to a linear list of statements.
     */
