 ...
 *
 * Author: wbb
 * Time-stamp: <2010-06-09 16:11:43 wbb>
 */
...
class Yytoken {
    ...
    Yytoken(int kind, String t, int line, int begin, int end, Object value) {
        my_kind = kind;
...
%{
    ...
    private Yytoken tok(int kind, String str, Object value) {
        return new Yytoken(kind, str, lineNum, lineIndex(yychar),
                           lineIndex(yychar)+yylength(), value);
    }
...
<YYINITIAL> (_|{ALPHA})({ALPHA}|{DIGIT})*  { return tok(sym.ID, yytext(), null); }
